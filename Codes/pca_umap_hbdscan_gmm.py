...
if __name__ == '__main__':
    ...
    po_ = 2
    smoothSpec_sav = _smooth_spectrum(refSpec, method='savgol', window_length=wl_, polyorder=po_)
    ...
    def update(val):
        ...
        smoothSpec_sav = _smooth_spectrum(refSpec, method='savgol', window_length=current_v, polyorder=po_)
